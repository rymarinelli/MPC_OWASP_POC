...
def open_pull_request(github_token: str | None, repository: str | None, head: str, base: str, vulnerabilities) -> None:
...
def main() -> int:
    ...
    try:
        ...
        stage_and_commit(repo_root, applied_files, commit_message)
